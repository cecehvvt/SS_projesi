...
class ProfilEkrani extends StatelessWidget {
  ...
  const ProfilEkrani({super.key, this.showBackButton = true});
              ...
              Row(
                ...
                children: [
                  _buildIstatistik(
                    ...
                    sayi: '12',
                    baslik: 'Bağışladıklarım',
                    renk: Colors.green,
                  ),
                  _buildIstatistik(
                    ikon: Icons.favorite_border,
                    sayi: '5',
                    baslik: 'İhtiyaç Taleplerim',
                    renk: Colors.purple,
                  ),
                  _buildIstatistik(
                    ikon: Icons.swap_horiz,
                    sayi: '3',
                    baslik: 'Takas İlanlarım',
                    renk: Colors.blue,
                  ),
                  _buildIstatistik(
                    ikon: Icons.bookmark_border,
                    sayi: '18',
                    baslik: 'Kaydedilenlerim',
                    renk: Colors.orange,
                  ),
                ],
              ),
      ...
      child: Row(
        children: [
          Icon(
            ikon,
            size: 16,
            color: secili ? Colors.green : Colors.grey.shade500,
          ),
